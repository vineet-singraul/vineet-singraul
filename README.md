...
<div align="center" style="
    background: linear-gradient(135deg, #ff007f, #6100ff);
    padding: 20px;
    border-radius: 15px;
    box-shadow: 0px 4px 20px rgba(255, 0, 150, 0.5);
    display: inline-block;
">
  <h3 style="color: white; font-family: Arial, sans-serif;">🚀 My Contributions</h3>
  
  <p>
    <a href="https://github.com/vineet-singraul">
      <img src="https://github-contribution-stats.vercel.app/api/?username=vineet-singraul&theme=radical" 
           alt="Contribution Stats" 
           style="border-radius: 10px; box-shadow: 0px 0px 15px rgba(255, 0, 150, 0.7);"/>
    </a>
  </p>
</div>
